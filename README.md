...
# Go Build Action [![CI](https://github.com/step-security/actions-go-build/actions/workflows/test.yml/badge.svg)](https://github.com/step-security/actions-go-build/actions/workflows/test.yml)
...
jobs:
  example:
    ...
    steps:
      ...
      - name: Build
        uses: step-security/actions-go-build@v1
        with:
          go_version: 1.24
          os: linux
          arch: amd64
...
See also the [example workflow](#More-Realistic-Example) above,
